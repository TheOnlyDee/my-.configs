...
static const Key keys[] = {
  ...
  /* Keys By TheOnlyDee */  
  { MODKEY, XK_w, spawn, SHCMD("librewolf -P PAOLO") },
  { MODKEY|ShiftMask, XK_w, spawn, SHCMD("librewolf -ProfileManager") },
  { MODKEY, XK_o, spawn, SHCMD("libreoffice") },
  { MODKEY|ShiftMask, XK_p, spawn, SHCMD("st -- nnn") },
  { MODKEY|ShiftMask, XK_n, spawn, SHCMD("st -- newsboat") },
  { MODKEY, XK_n, spawn, SHCMD("st -- distrobox enter arch -- nvim") },
	...
	{ 0, XF86XK_MonBrightnessUp,	spawn,		{.v = (const char*[]){ "brightnessctl", "s", "+20%", NULL } } },
	{ 0, XF86XK_MonBrightnessDown,	spawn,		{.v = (const char*[]){ "brightnessctl", "s", "20%-", NULL } } },
